...
# リーグ平均防御率を計算
def calc_league_total_innings_fnc(a_year_idx, a_team):
    # 初期化
    t_era = ""
    t_league = ""
    t_fraction_innings_sum = Fraction(0)
    ...
    for s in t_innings_list:
        ...
        t_fraction_innings_sum = t_fraction_innings_sum + t_fraction_innings

    return t_fraction_innings_sum
